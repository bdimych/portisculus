...
$rangeNeeded = 153..156         # нужный диапазон bpm
rangeCoefAllowed = [0.91, 1.35] # максимальный коэфициент на который можно менять bpm (по моим впечатлением больше 1.2 и меньше 0.9 песня уже слух корябит, становится непохожа на саму себя)
